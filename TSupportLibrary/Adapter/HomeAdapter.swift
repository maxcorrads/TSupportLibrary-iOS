...
open class HomeAdapter {
    public static func cellForRowAt(_ tableView: UITableView, _ indexPath: IndexPath, _ value: TableGenericElement, _ vc: UIViewController) -> UITableViewCell{
    ...
    public static func heightForRowAt(_ tableView: UITableView, _ indexPath: IndexPath, _ value: TableGenericElement) -> CGFloat{
